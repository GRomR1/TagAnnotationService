...
var hashDictExt = parseDictionary('./etc/files/tanen_index_full.csv');


//****************************** parseTextData **************************
// Функция обработки запроса с текстовыми данными
var parseTextData = function (data, res) {
    ...
    var ress = findStemsInDict(taTokens3, hashDictExt); //получаем хэш таблицу со словарными понятиями и их частотой
